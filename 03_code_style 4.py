...
# PEP8 (Python Enhancement Proposal 8) - описан "правильный" стиль программирования в Pyton
...
# t (одиночная маленькая буква)
# B (одиночная заглавная буква)
# но лучше использовать только такие имена: из одной буквы
#   i j k - для циклов
#   x y z - для координат
...
# В каждой уважающей себя компании есть style guide (style-гайд) - руководство по стилю написания кода.
